...
import com.example.pedro.proyecto_pgl_2018.Entidades.Usuario;
...
public class ConsultarFragment extends Fragment implements Response.Listener<JSONObject>, Response.ErrorListener {
    ...
    TextView txtNombre, txtApellidos, txtPassword;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View vista = inflater.inflate(R.layout.fragment_consultar, container, false);
        identificador = vista.findViewById(R.id.identificador);
    ...
    private void cargarWebService() {
        ...
        String url = ip+"/BD_remota/consultaUsuario.php?PK_ID="+identificador.getText().toString();
    ...
    public void onErrorResponse(VolleyError error) {
        ...
        progreso.hide();
        Toast.makeText(getContext(), "No se puedo consultar" + error.toString(), Toast.LENGTH_SHORT).show();
    ...
    public void onResponse(JSONObject response) {
        ...
        try {
            ...
            miUsuario.setApellidos(jsonObject.optString("apellidos"));
        } catch (JSONException e) {
            e.printStackTrace();
        }

        txtNombre.setText("Nombre del Usuario: " + miUsuario.getNombre());
        txtPassword.setText("Contraseña: "+ miUsuario.getPassword());
        txtApellidos.setText("Apellidos: " + miUsuario.getApellidos());
