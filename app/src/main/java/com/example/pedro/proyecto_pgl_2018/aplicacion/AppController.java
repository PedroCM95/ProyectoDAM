package com.example.pedro.proyecto_pgl_2018.aplicacion;
...
import com.example.pedro.proyecto_pgl_2018.volley.Utils.LruBitmapCache;
...
public class AppController extends Application {
    ...
    public static final String AUTHORITY = ManagerEventApplication.AUTHORITY;
    // An account type, in the form of a domain name
    public static final String ACCOUNT_TYPE = "com.example.pedro.proyecto_pgl_2018";
    // The account name
    public static final String ACCOUNT = "Proyecto";
    // Sync interval constants
    public static final long SYNC_INTERVAL = Utilidades.SYNC_INTERVAL; // Cada 2 minutos
